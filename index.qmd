...
To further investigate their questions, the group designed and conducted a survey for students at Henninger High School (n=36) focused on winter transportation experiences. Students shared data on their project through [HydroShare](https://hydroshare.org/), an open repository for sharing and discovering water-related data and research materials. 
...
From the data collected by the group, less students than expected cited that their street was rarely plowed when they leave for school in the morning. The data suggests that students who live on streets that are not plowed less often may be late more often to school, but this is not conclusive. To better understand these relationships, the survey is recommended to be given to a larger cohort of stuents. 

Furthermore, the group also found that there is not enough publically available information for a deeper understanding around inequities around municipal snow removal services and access to education in Syracuse.
